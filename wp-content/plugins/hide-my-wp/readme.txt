...
Tags: hide my wp,wordpress security,security plugin,hide wp-admin,hide my wordpress,wordpress security plugin,hide wp-login,hide my site,tips,apps,wordpress apps,plugin,wordpress plugin,url,admin,login,path,paths
Requires at least: 4.0
Tested up to: 4.8
Stable tag: trunk
Donate link: https://wpplugins.tips/wordpress

Hide My WP it's a Wordpress Security plugin. You can change and hide Wordpress Admin and Login URLs to increases your Wp Security against hackers
...
> <strong>Hide My WP Lite Features:</strong>
>
...
> <strong>Hide My WP PRO features:</strong>
>
